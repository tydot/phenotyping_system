...
class PatientReportPDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 6, f"ARM Report | Patient {self.patient_id}", align="C")
        self.ln(8)
    ...
    def add_clinical(self, am):
        self._np(50); self._t("Clinical Metrics")
        if am:
            for item in am:
